 ...
 *	匹配任何元素节点。
 ...
 GDataXMLNode.h 中出现’libxml/tree.h’ file not found的解决方法（Build Settings选项下）：
 1.Header Search Paths 该为
   ${SDKROOT}/usr/include/libxml2
 或者 /usr/include/libxml2
 
 2.other Linker Flags添加  -lxml2
 
 3.部分工程还需要向Frameworks文件中添加libxml2.dylib
 ...
     //使用NSData对象初始化
     NSError *error=nil;
     GDataXMLDocument *doc = [[GDataXML Documentalloc] initWithData:xmlData  options:0 error:&error];
     
     //获取根节点（Users）
